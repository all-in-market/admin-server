...
class AdminOrderServiceTest {
    ...
    void 관리자_주문목록_조회_성공_테스트() {
        ...
        // when
        PageResponse<OrderDetailResponse> result = adminOrderService.findAll(pageable);
    ...
    void 관리자_주문상태_변경_성공_테스트() {
        ...
        // when
        OrderDetailResponse result = adminOrderService.updateStaus(orderId, request);
    ...
    void 관리자_주문상태_변경_주문없음_실패_테스트() {
        ...
        BaseException exception = assertThrows(
                BaseException.class,
                () -> adminOrderService.updateStaus(orderId, request)
        );
